...
function loadArticles() {
  var paginate = pages.length * 50 || 1;
  var url = "https://www.sydnarkenytt.se/json/etta/P" + paginate;
  fetch(url).then(function (resp) {
    return resp.json();
  }).then(function (resp) {
    pages[pages.length] = resp;
  });
} // function buildHTML(pages) {
//     document.body.innerHTML = ""
//     let yttrediv = document.createElement("div")
//     for (let page of pages) {
//         for (let article of page) {
//             let artikel = document.createElement("div")
//             let rub = document.createElement("h1")
//             rub.innerHTML = article.title
//             artikel.appendChild(rub)
//             if (article.ingress) {
//                 let ingress = document.createElement("P")
//                 ingress.innerHTML = article.ingress
//                 artikel.appendChild(ingress)
//             }
//             yttrediv.appendChild(artikel)
//         }
//     }
//     document.body.append(yttrediv)
// }


var sida = {
  view: function view() {
    return mithril_1.default("h1", "Här kommer texten");
  }
};
Mithril.mount(document.body, sida);
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script.ts"], null)
